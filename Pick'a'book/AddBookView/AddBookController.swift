...
class AddNewBookController: UIViewController {
    var presenter: AddNewBookPresenter
    ...
    init(presenter: AddNewBookPresenter){
...
extension AddNewBookController {
    @objc
...
extension AddNewBookController: UITextViewDelegate {
...
extension AddNewBookController {
    ...
    func hideKeyboardWhenTappedAround() {
        let tap = UITapGestureRecognizer(target: self,
                                         action: #selector(AddNewBookController.dismissKeyboard))
...
// for genre picker
extension AddNewBookController:UIPickerViewDelegate, UIPickerViewDataSource {
...
extension AddNewBookController : UIImagePickerControllerDelegate, UINavigationControllerDelegate {
